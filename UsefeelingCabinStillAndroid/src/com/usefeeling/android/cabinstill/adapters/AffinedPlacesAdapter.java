...
public class AffinedPlacesAdapter extends ArrayAdapter<Place> {
	 ...
	 */
	public AffinedPlacesAdapter(Activity _activity, int layoutResourceId, ArrayList<Place> objects) {
	 ...
	 *
	 */
	private static class AffinedPlaceHolder {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		AffinedPlaceHolder holder;
		if (convertView == null) {
			convertView = this.inflater.inflate(this.layoutId, null);
			holder = new AffinedPlaceHolder();
			...
			holder = (AffinedPlaceHolder) convertView.getTag();
		}
