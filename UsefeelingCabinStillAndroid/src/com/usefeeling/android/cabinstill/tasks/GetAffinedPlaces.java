...
/**
 * Tarea asíncrona de obtención de los locales más afines de un usuario.<br>
 ...
 * de los locales más afines del usuario</li>
 * @author Moisés Vilar.
 *
 */
public class GetAffinedPlaces extends AbstractTask {
	 ...
	 */
	public GetAffinedPlaces(Activity activity, OnTaskCompleted listener, Object...params) {
	...
	public void run() {
		try {
			...
			this.places = this.mUsefeeling.getAffinedPlaces(userid);
